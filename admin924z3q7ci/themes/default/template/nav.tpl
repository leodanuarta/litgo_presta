            ...
            {if $level_1.sub_tabs|@count}
              {foreach $level_1.sub_tabs as $level_2}
                {if $level_2.active}
                  ...
                  {/if}
                  {if $level_2.class_name != 'AdminParentOrders'}
                    ...
                    {if $level_2.sub_tabs|@count}
                      <ul id="collapse-{$level_2.id_tab}" class="submenu panel-collapse">
                        {foreach $level_2.sub_tabs as $level_3}
                          {if $level_3.active}
                            {if $level_3.class_name != 'AdminOrders' && $level_3.class_name != 'AdminInvoices' && $level_3.class_name != 'AdminSlip' && $level_3.class_name != 'AdminSlip' && $level_3.class_name != 'AdminCarts' && $level_3.class_name != 'AdminDeliverySlip'}

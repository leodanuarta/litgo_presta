...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			<img id="logo" src="{$img_dir}logo-small-nobg.png"  alt="" />
		</h1>
	...
	<div class="flip-container" style="margin-top: -10px;">
		<div class="flipper">
			<div class="front front_login panel" {if isset($reset_token) && isset($id_employee)}style="display:none;"{/if}>
				<h4 id="shop_name">{$shop_name} Admin Dashboard</h4>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="#">
				&copy; Prabata Lavanaa&#8482;{$smarty.now|date_format:"%Y"} - All rights reserved
			</a>
		</p>
	</div>
</div>

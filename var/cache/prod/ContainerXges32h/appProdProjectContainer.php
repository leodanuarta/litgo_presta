...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('N4RvWkO3gX', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'litgo_presta', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a807d4f87ee71567380d16680caceec1e2fea6879ea5c6ad3bdb87aa53a00fd3');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Te4bsPvAdBmP6zItfSw6a9DwAOJNqhiLx7zGQZSx3RPKafEXimLsLbZhpP7FF7vg'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Te4bsPvAdBmP6zItfSw6a9DwAOJNqhiLx7zGQZSx3RPKafEXimLsLbZhpP7FF7vg');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                60 => ($this->targetDirs[3].'/modules/ps_categorytree_mod/translations'),
                61 => ($this->targetDirs[3].'/modules/ets_reviewticker/translations'),
                62 => ($this->targetDirs[3].'/modules/ets_mailchimpsync/translations'),
                63 => ($this->targetDirs[3].'/modules/pleasewait/translations'),
                64 => ($this->targetDirs[3].'/modules/ets_homecategories/translations'),
                65 => ($this->targetDirs[3].'/modules/ets_megamenu/translations'),
                66 => ($this->targetDirs[3].'/modules/ets_multilayerslider/translations'),
                67 => ($this->targetDirs[3].'/modules/ybc_newsletter/translations'),
                68 => ($this->targetDirs[3].'/modules/paypal/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                71 => 'pleasewait',
                72 => 'ets_homecategories',
                73 => 'ets_megamenu',
                74 => 'ets_multilayerslider',
                75 => 'ets_purchasetogether',
                76 => 'ybc_newsletter',
            ...
            'kernel.secret' => 'Te4bsPvAdBmP6zItfSw6a9DwAOJNqhiLx7zGQZSx3RPKafEXimLsLbZhpP7FF7vg',
